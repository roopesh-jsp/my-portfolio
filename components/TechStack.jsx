...
export default function TechStackSection() {
  return (
    <section className="text-white py-24 px-6 relative min-h-[650px] sm:min-h-[550px] overflow-hidden">
      {/* Heading */}
      ...
      {techRows.map((row, index) => (
        ...
        >
          {/* Gradient fade edges */}
          <div className="absolute left-0 top-0 h-full w-12 sm:w-16 bg-gradient-to-r from-[#19191B] to-transparent z-20" />
          <div className="absolute right-0 top-0 h-full w-12 sm:w-16 bg-gradient-to-l from-[#19191B] to-transparent z-20" />
